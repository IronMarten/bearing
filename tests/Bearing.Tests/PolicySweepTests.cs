...
public sealed class PolicySweepTests(CoreWalkFixture core)
{
    ...
    private static readonly Dictionary<string, double> Notches = new(StringComparer.Ordinal)
    {
        ...
        [nameof(AnalysisPolicy.ConcealedTopShare)] = 0.05,
        [nameof(AnalysisPolicy.ConcealedDispersionFactor)] = 1,
    ...
    private static AnalysisPolicy Set(AnalysisPolicy policy, string name, double v) => name switch
    {
        ...
        nameof(AnalysisPolicy.ConcealedTopShare) => policy with { ConcealedTopShare = v },
        nameof(AnalysisPolicy.ConcealedDispersionFactor) => policy with { ConcealedDispersionFactor = v },
